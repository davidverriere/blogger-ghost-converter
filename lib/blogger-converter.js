...
BloggerConverter.prototype.getArgs = function () {
...
BloggerConverter.prototype.parseXmlBloggerFile = function (bloggerFilePath) {
    if (!bloggerFilePath) {
...
BloggerConverter.prototype.createGhostFile = function () {
...
BloggerConverter.prototype.createGhostPost = function (entry, postId) {
    var post = {
        id: postId,
...
BloggerConverter.prototype.addPostTags = function (entry, postId) {
...
BloggerConverter.prototype.getTagId = function (tagName) {
...
BloggerConverter.prototype.createGhostImport = function () {
    var ghostImport = {
        meta: {
...
*/
BloggerConverter.prototype.isBloggerPost = function (entry) {
...
module.exports = BloggerConverter;